                        ...
                        link.title === "Catalog" ? (
                            <div className={`group relative flex cursor-pointer items-center gap-1 ${
                                ...
                                {loading ? (
                                    ...
                                    <>
                                        {/* {console.log("SubLinks Length ", subLinks.map((subLink, i) => <li key={i}>{console.log(subLink.name.split("/").join("-").toLowerCase())}</li>))} */}
                                        {subLinks
                                            ?.map((subLink, i) => (
                                                <Link
                                                    to={`/catalog/${subLink.name.split("/").join("-").toLowerCase()}`}
                                                    className='rounded-lg text-base bg-transparent py-3 pl-4 hover:bg-richblack-50'
                                                    key={i}
                                                >
                                                    <p>{subLink.name}</p>
                                                </Link>
