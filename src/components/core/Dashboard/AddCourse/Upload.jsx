...
const Upload = ({
  ...
  return (
    <div className='flex flex-col space-y-2'>
        ...
        <div
          className={`${isDragActive ? "bg-richblack-600" : "text-richblack-700"}
        ...
        {previewSourse ? (
            ...
            >
                ...
                <div className='grid aspect-square w-14 place-items-center rounded-full bg-richblack-900'> {/** bg-pure-greys-800 */}
