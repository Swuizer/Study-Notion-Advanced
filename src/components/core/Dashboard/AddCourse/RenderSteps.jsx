...
export default function RenderSteps() {
  ...
  return (
    <>
      <div className='relative mb-2 flex w-full justify-center'>
        {
          steps.map( (item) => (
            <>
              ...
              {/* Add code for dashed between the lable */}
      ...
      <div className='relative mb-16 flex w-11/12 select-none justify-between'>
        {
          steps.map((item) => (
            <>
              <div key={item.id}
                className='flex min-w-[130px] flex-col items-end gap-y-2'
              >
                <p className={`text-sm ${
