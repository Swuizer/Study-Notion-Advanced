...
const About = () => {
  return (
    <div>
            ...
            <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500'>
                ...
                <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                    ...
                    <div className='my-24 flex lg:w-[50%] flex-col gap-10'>
                        ...
                        vision and passion for transforming education. It all 
                        began with a group of educators, technologists, and 
                ...
                <div className='flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
                    ...
                    <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                        ...
                        to create an e-learning platform that would revolutionize 
                        the way people learn. Our team of dedicated experts worked 
                        tirelessly to develop a robust and intuitive platform that 
                        combines cutting-edge technology with engaging content, fostering 
                    ...
                    <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                        ...
                        to create a vibrant community of learners, where individuals can connect, 
        ...
        {/* Section 6 */}
        <section className='mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white'>
            <h1 className='text-center text-4xl w-full font-semibold mt-8'>
