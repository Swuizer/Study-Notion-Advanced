...
const CourseDetails = () => {
    ...
    {console.log("Course Data Time Duration", courseData?.data[0]?.courseContent?.[0]?.subSection?.[0]?.timeDuration)}
    {console.log("Course Data Time Duration", courseData)}

    // <div className='flex items-center ml-10'>
    //     <button className='bg-yellow-50 px-6 py-3 mt-10'
...
<div>
    ...
    <div className='flex gap-x-3 justify-between'>
        <div>
            ...
            <span>
                {courseData.data[0]?.totalDuration} total duration
            </span>
        </div>
        <div>
            <button
